...
class ControllerExtensionPaymentFaspayVabni extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_vabni', 0);
		...
		$data['gateway'] 				= '801';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_vabni_expired_order'];
		$data['server']					= $setting['faspay_vabni_server'];

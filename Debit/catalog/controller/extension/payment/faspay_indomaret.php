...
class ControllerExtensionPaymentFaspayIndomaret extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_indomaret', 0);
		...
		$data['gateway'] 				= '706';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_indomaret_expired_order'];
		$data['server']					= $setting['faspay_indomaret_server'];

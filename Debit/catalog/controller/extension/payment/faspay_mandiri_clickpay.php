...
class ControllerExtensionPaymentFaspayMandiriClickpay extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_mandiri_clickpay', 0);
		...
		$data['gateway'] 				= '406';
		$data['flow']					= '1';
		$data['order_expired']			= $setting['faspay_mandiri_clickpay_expired_order'];
		$data['server']					= $setting['faspay_mandiri_clickpay_server'];

...
class ControllerExtensionPaymentFaspayXltunai extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_xltunai', 0);
		...
		$data['gateway'] 				= '303';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_xltunai_expired_order'];
		$data['server']					= $setting['faspay_xltunai_server'];

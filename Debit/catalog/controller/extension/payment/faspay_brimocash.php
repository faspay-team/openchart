...
class ControllerExtensionPaymentFaspayBrimocash extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_brimocash', 0);
		...
		$data['gateway'] 				= '400';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_brimocash_expired_order'];
		$data['server']					= $setting['faspay_brimocash_server'];

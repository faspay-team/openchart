...
class ControllerExtensionPaymentFaspayDanamonOb extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_danamon_ob', 0);
		...
		$data['gateway'] 				= '701';
		$data['flow']					= '1';
		$data['order_expired']			= $setting['faspay_danamon_ob_expired_order'];
		$data['server']					= $setting['faspay_danamon_ob_server'];

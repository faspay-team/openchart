...
class ControllerExtensionPaymentFaspayVapermata extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_vapermata', 0);
		...
		$data['gateway'] 				= '402';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_vapermata_expired_order'];
		$data['server']					= $setting['faspay_vapermata_server'];

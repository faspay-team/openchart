...
class ControllerExtensionPaymentFaspayMandiriBillpayment extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_mandiri_billpayment', 0);
		...
		$data['gateway'] 				= '703';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_mandiri_billpayment_expired_order'];
		$data['server']					= $setting['faspay_mandiri_billpayment_server'];

...
class ControllerExtensionPaymentFaspayVabri extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_vabri', 0);
		...
		$data['gateway'] 				= '800';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_vabri_expired_order'];
		$data['server']					= $setting['faspay_vabri_server'];

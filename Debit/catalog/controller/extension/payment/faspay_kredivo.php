...
class ControllerExtensionPaymentFaspayKredivo extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_kredivo', 0);
		...
		$data['gateway'] 				= '709';
		$data['flow']					= '1';
		$data['order_expired']			= $setting['faspay_kredivo_expired_order'];
		$data['server']					= $setting['faspay_kredivo_server'];

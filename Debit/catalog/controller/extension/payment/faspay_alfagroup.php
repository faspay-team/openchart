...
class ControllerExtensionPaymentFaspayAlfagroup extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_alfagroup', 0);
		...
		$data['gateway'] 				= '707';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_alfagroup_expired_order'];
		$data['server']					= $setting['faspay_alfagroup_server'];

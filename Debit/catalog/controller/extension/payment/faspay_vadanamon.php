...
class ControllerExtensionPaymentFaspayVadanamon extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_vadanamon', 0);
		...
		$data['gateway'] 				= '708';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_vadanamon_expired_order'];
		$data['server']					= $setting['faspay_vadanamon_server'];

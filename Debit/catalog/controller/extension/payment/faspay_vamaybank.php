...
class ControllerExtensionPaymentFaspayVamaybank extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_vamaybank', 0);
		...
		$data['gateway'] 				= '408';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_vamaybank_expired_order'];
		$data['server']					= $setting['faspay_vamaybank_server'];

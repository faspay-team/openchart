...
class ControllerExtensionPaymentFaspayVamandiri extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_vamandiri', 0);
		...
		$data['gateway'] 				= '802';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_vamandiri_expired_order'];
		$data['server']					= $setting['faspay_vamandiri_server'];

...
class ControllerExtensionPaymentFaspayakulaku extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_akulaku', 0);
		...
		$data['gateway'] 				= '807';
		$data['flow']					= '1';
		$data['order_expired']			= $setting['faspay_akulaku_expired_order'];
		$data['server']					= $setting['faspay_akulaku_server'];

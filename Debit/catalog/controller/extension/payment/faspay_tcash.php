...
class ControllerExtensionPaymentFaspayTcash extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_tcash', 0);
		...
		$data['gateway'] 					= '302';
		$data['flow']					= '1';
		$data['order_expired']			= $setting['faspay_tcash_expired_order'];
		$data['server']					= $setting['faspay_tcash_server'];

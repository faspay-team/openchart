...
class ControllerExtensionPaymentFaspayBriepay extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_briepay', 0);
		...
		$data['gateway'] 				= '401';
		$data['flow']					= '1';
		$data['order_expired']			= $setting['faspay_briepay_expired_order'];
		$data['server']					= $setting['faspay_briepay_server'];

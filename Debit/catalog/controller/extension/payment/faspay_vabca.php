...
class ControllerExtensionPaymentFaspayVabca extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_vabca', 0);
		...
		$data['gateway'] 				= '702';
		$data['flow']					= '2';
		$data['order_expired']			= $setting['faspay_vabca_expired_order'];
		$data['server']					= $setting['faspay_vabca_server'];

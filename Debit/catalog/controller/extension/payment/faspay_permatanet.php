...
class ControllerExtensionPaymentFaspayPermatanet extends Controller {
	...
	public function index() {	
		...
		$setting = $this->model_setting_setting->getSetting('faspay_permatanet', 0);
		...
		$data['gateway'] 				= '402';
		$data['flow']					= '1';
		$data['order_expired']			= $setting['faspay_permatanet_expired_order'];
		$data['server']					= $setting['faspay_permatanet_server'];

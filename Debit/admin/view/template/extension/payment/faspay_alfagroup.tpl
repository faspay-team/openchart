  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-faspay-alfagroup" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
...
<div class="container-fluid">
  ...
  <div class="tab-content">
      ...
      <div class="form-group required">
        ...
        <div class="col-sm-10">
        <select name="faspay_alfagroup_status" placeholder="Select your status enable here" id="faspay-tcash-status" class="form-control">
                      <?php if ($faspay_alfagroup_status) { ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
        <select name="faspay_alfagroup_geo_zone_id" placeholder="Select your geo zone here" id="input-geo-zone" class="form-control">
                        <option value="0"><?php echo $text_all_zones; ?></option>
                        <?php foreach ($geo_zones as $geo_zone) { ?>
                            <?php if ($geo_zone['geo_zone_id'] == $faspay_alfagroup_geo_zone_id) { ?>
      ...
      <div class="form-group required">
        ...
        <div class="col-sm-10">
        <select name="faspay_alfagroup_expired_order" id="input-transaction-expired" placeholder="Select your Expired Date Order here" class="form-control">
                    <?php $i = 1;
                        while ($i <= 24):
                    ?>
                    <?php if ($faspay_alfagroup_expired_order == $i){ ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" name="faspay_alfagroup_sort_order" value="<?php echo $faspay_alfagroup_sort_order; ?>"  id="input-sort-order" class="form-control" />
        </div>
      </div>

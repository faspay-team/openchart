<?php
class ControllerExtensionPaymentFaspayOvo extends Controller {
	...
	public function index() {
		...
		$this->load->language('extension/payment/faspay_ovo');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			$this->load->model('setting/setting');
			$this->model_setting_setting->editSetting('faspay_ovo', $this->request->post);
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/payment/faspay_ovo', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$data['action'] = $this->url->link('extension/payment/faspay_ovo', 'token=' . $this->session->data['token'], 'SSL');

    	$data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'], 'SSL');

    	$inputs = array(
      		'faspay_ovo_server',
      		'faspay_ovo_geo_zone_id',
      		'faspay_ovo_expired_order',
      		'faspay_ovo_sort_order',
      		'faspay_ovo_status'
    	);
		...
		$this->template = 'extension/payment/faspay_ovo.tpl';

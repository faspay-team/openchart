...
class ControllerExtensionPaymentFaspayCimbclicks extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			$this->load->model('setting/setting');
			$this->model_setting_setting->editSetting('faspay_cimbclicks', $this->request->post);
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/payment/faspay_cimbclicks', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$data['action'] = $this->url->link('extension/payment/faspay_cimbclicks', 'token=' . $this->session->data['token'], 'SSL');

    	$data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'], 'SSL');

    	$inputs = array(
      		'faspay_cimbclicks_server',
      		'faspay_cimbclicks_geo_zone_id',
      		'faspay_cimbclicks_expired_order',
      		'faspay_cimbclicks_sort_order',
      		'faspay_cimbclicks_status'
    	);
		...
		$this->template = 'extension/payment/faspay_cimbclicks.tpl';

...
class ControllerExtensionPaymentFaspaySakuku extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
			$this->load->model('setting/setting');
			$this->model_setting_setting->editSetting('faspay_sakuku', $this->request->post);
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/payment/faspay_sakuku', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
		
		$data['action'] = $this->url->link('extension/payment/faspay_sakuku', 'token=' . $this->session->data['token'], 'SSL');

    	$data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'], 'SSL');

    	$inputs = array(
      		'faspay_sakuku_server',
      		'faspay_sakuku_geo_zone_id',
      		'faspay_sakuku_expired_order',
      		'faspay_sakuku_sort_order',
      		'faspay_sakuku_status'
    	);
		...
		$this->template = 'extension/payment/faspay_sakuku.tpl';
